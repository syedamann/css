...
"""
Input:
Enter the value of prime number p = 17
Enter the value of prime number q = 13
Enter the value of message m = Aman
Public Key [e,n] =  (151, 221)
Cipher text =  [91, 216, 7, 202]
Private Key [d,n] =  (103, 221)
Plain text after decryption =  Aman
"""